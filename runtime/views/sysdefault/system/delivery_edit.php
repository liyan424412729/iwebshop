				...
				<tr>
					...
					<td>
						...
						<span id='protectBox' style='display:none'>
							...
							<label>按照货物总金额的《费率》计算，但是保价金额最低不低于《最低保价费》</label>
						</span>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<div class='content_box' style='padding:6px'>
							...
							选择地区：
							<select>
								<?php foreach($items=$this->areaList as $key => $item){?>
						...
						<button type="button" class="btn" onclick='addArea()'><span class="add">添加规则</span></button>
					</td>
				</tr>
			</table>
