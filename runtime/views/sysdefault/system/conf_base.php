	...
	<div class="content form_content">
		...
		<form action="<?php echo IUrl::creatUrl("/system/save_conf/form_index/system_conf");?>" method="post" name='system_conf'>
			<table class="form_table">
				...
				<tr>
					<th>上传容量限制：</th>
					<td><input type='text' name='uploadSize' class='small' empty pattern='int' alt='请输入MB数量' />MB <label>上传图片及附件的容量限制，单位：MB</label></td>
				</tr>
				<tr>
					<th>设置语言包：</th>
					<td>
				...
				<tr>
					<th>授权编号：</th>
					<td><input type='text' name='authorizeCode' class='normal' empty /><label>购买正式授权的编号 <a href="http://product.aircheng.com" target="_blank">点击查询</a></label></td>
				</tr>
