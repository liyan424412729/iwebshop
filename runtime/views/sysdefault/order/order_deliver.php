	...
	<form action="<?php echo IUrl::creatUrl("/order/order_delivery_doc");?>" method="post" id="deliver_form">
			...
			<tbody>
				...
				<tr>
					<td>
						...
						<img src="<?php echo $this->getWebSkinPath()."images/admin/seller_ico.png";?>" alt="商户商品" title="商户商品" />
						<?php }?>
		...
		<table width="95%" class="border_table" style="margin:10px auto">
			...
			<tbody>
				...
				<tr>
					<th>自提点:</th>
					<td align="left" colspan="3"><?php echo isset($takeself['name'])?$takeself['name']:"";?></td>
				</tr>
				<tr>
					<th>自提地址:</th>
					<td align="left" colspan="3"><?php echo isset($takeself['address'])?$takeself['address']:"";?></td>
				</tr>
				<?php }else{?>
				<tr>
					<th>物流公司：</th>
