...
<form name="ModelForm" action="<?php echo IUrl::creatUrl("/order/order_update");?>" method="post">
			...
			<table class="form_table">
				...
				<tbody>
					...
					<tr>
						<th>是否要发票：</th>
						<td>
							<label class='attr'><input type="checkbox" name="invoice" value="1" onchange="$('#taxArea').toggle();" />发票</label>
						</td>
					</tr>
					<tr id="taxArea" style="display:none;">
						...
						<td>
							<table>
								<tr>
									<td>公司名称：<input class="normal" type="text" name="invoice_company_name" value="" /></td>
									<td>纳税人识别码：<input class="normal" type="text" name="invoice_taxcode" value="" /></td>
								</tr>

								<tr>
									<td>注册地址：<input class="normal" type="text" name="invoice_address" value="" /></td>
									<td>注册电话：<input class="normal" type="text" name="invoice_telphone" value="" /></td>
								</tr>

								<tr>
									<td>开户银行：<input class="normal" type="text" name="invoice_bankname" value="" /></td>
									<td>银行账号：<input class="normal" type="text" name="invoice_bankno" value="" /></td>
								</tr>

								<tr>
									<td>
										发票类型：
										<select name="invoice_type" class="normal">
	...
	<div class="pages_bar"><div class="t_c"><button type="submit" class="submit" disabled="disabled"><span>保 存</span></button></div></div>
</form>
