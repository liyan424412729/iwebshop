...
<section class="breadcrumb">
	<span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>">首页</a> » <a href="<?php echo IUrl::creatUrl("/site/products/id/".$this->goods['goods_id']."");?>"><?php echo isset($this->goods['name'])?$this->goods['name']:"";?></a>
</section>
