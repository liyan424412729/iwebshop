...
<section class="breadcrumb">
	<span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>">首页</a> » <a href="<?php echo IUrl::creatUrl("/site/products/id/".$this->goods['goods_id']."");?>">评论</a>
</section>
...
<section class="web">
	<section class="main">
		<header class="uc_head">
			<h3 name="tips"><a href="<?php echo IUrl::creatUrl("/site/comments_list/id/".$this->goods['goods_id']."");?>">全部评论(<?php echo isset($this->commentCount['comment_total'])?$this->commentCount['comment_total']:"";?>条)</a></h3>
			<h3 name="tipsgood"><a href="<?php echo IUrl::creatUrl("/site/comments_list/id/".$this->goods['goods_id']."/type/good");?>">好评(<?php echo isset($this->commentCount['point_grade']['good'])?$this->commentCount['point_grade']['good']:"";?>条)</a></h3>
			<h3 name="tipsmiddle"><a href="<?php echo IUrl::creatUrl("/site/comments_list/id/".$this->goods['goods_id']."/type/middle");?>">中评(<?php echo isset($this->commentCount['point_grade']['middle'])?$this->commentCount['point_grade']['middle']:"";?>条)</a></h3>
			<h3 name="tipsbad"><a href="<?php echo IUrl::creatUrl("/site/comments_list/id/".$this->goods['goods_id']."/type/bad");?>">差评(<?php echo isset($this->commentCount['point_grade']['bad'])?$this->commentCount['point_grade']['bad']:"";?>条)</a></h3>
		</header>
		<div class="comment_list">

			<?php foreach($items=$this->commentQuery->find() as $key => $item){?>
			<div class="comment_item">
				<div class="user">
					<img src="<?php echo IUrl::creatUrl("")."".$item['head_ico']."";?>" width="70px" height="70px" onerror="this.src='<?php echo $this->getWebSkinPath()."image/user_ico.gif";?>'" />
					<span><?php echo isset($item['username'])?$item['username']:"";?></span>
				</div>
				<div class="desc">
					<time><?php echo isset($item['time'])?$item['time']:"";?></time>
					<div class="star_box">
						<strong class="item">评分：</strong>
						<span class="star star_<?php echo Common::gradeWidth($item['point']);?>"></span>
					</div>
					<p class="contents"><strong>评价：</strong><span><?php echo isset($item['contents'])?$item['contents']:"";?></span></p>
				</div>
			</div>
			<?php }?>
		</div>
	...
	<aside class="bar">
		<div class="bar_box">
			...
			<div class="bar_goods_big">
				<a target="_blank" href="<?php echo IUrl::creatUrl("/site/products/id/".$this->goods['goods_id']."");?>">
					<img alt="<?php echo isset($this->goods['name'])?$this->goods['name']:"";?>" src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$this->goods['img']."/w/180/h/180");?>">
					<h5><?php echo isset($this->goods['name'])?$this->goods['name']:"";?></h5>
					<em>￥<?php echo isset($this->goods['sell_price'])?$this->goods['sell_price']:"";?></em>
					<label class="star_box">
						<span class="item">评分</span>
						<span class="star star_<?php echo Common::gradeWidth($this->commentCount['average_point']);?>"></span>
					</label>
				</a>
			</div>
		</div>
