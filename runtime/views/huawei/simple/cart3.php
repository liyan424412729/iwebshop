...
<section class="breadcrumb">
	<span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>">首页</a> » 成功提交订单
</section>
...
<section class="cart_3">
	...
	<div class="cart_3_con">
		...
		<div class="cart_3_status">
			<a href="<?php echo IUrl::creatUrl("/ucenter/order");?>">查看订单</a>
			<strong>订单已提交</strong>
		</div>
		<?php }?>
		<h3>订单信息</h3>
		<table>
			<col width="100">
			<col>
			<tr><th>订单编号：</th><td><?php echo $this->order_num;?></td></tr>
			<tr><th>订单金额：</th><td>￥<b><?php echo $this->final_sum;?></b></td></tr>
			<tr><th>备货时间：</th><td><?php echo $this->stockup_time;?>天</td></tr>
			<tr><th>支付方式：</th><td><?php echo $this->payment;?></td></tr>
			<tr><th>配送方式：</th><td><?php echo $this->delivery;?></td></tr>
		</table>
		<span class="show_more" id="order_a">[查看订单详细信息]</span>
		<table class="none" id='order_detail'>
			<col width="100">
			<col>
			<tr><th>收货人名：</th><td><?php echo isset($accept_name)?$accept_name:"";?></td></tr>
			<tr><th>联系方式：</th><td><?php echo isset($mobile)?$mobile:"";?></td></tr>
			<tr><th>收货时间：</th><td><?php echo isset($accept_time)?$accept_time:"";?></td></tr>
			<?php if($this->tax_title!=''){?>
			<tr><th>发票抬头：</th><td><?php echo $this->tax_title;?></td></tr>
			<?php }?>
		</table>
