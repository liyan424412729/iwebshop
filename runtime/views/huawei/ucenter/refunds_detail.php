...
<section class="col_table">
		<table>
				...
				<tr>
						<th>退款商品：</th>
						<td>
								<?php foreach($items=$this->data['goods'] as $key => $item){?> <?php $goodsInfo = JSON::decode($item['goods_array'])?>
								<p>
				...
				<tr>
						<th></th>
						<td>
								<input type="button" class="goback_btn" value="返 回" onclick='event_link("<?php echo IUrl::creatUrl("/ucenter/refunds");?>")'>
						</td>
				</tr>
		</table>
</section>
